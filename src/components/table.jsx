...
import { faPlus, faTrash, faPenToSquare,faChevronRight, faChevronLeft, faEllipsisVertical, faCaretUp } from '@fortawesome/free-solid-svg-icons'
import { library } from '@fortawesome/fontawesome-svg-core'
import SearchBar from "./searchTable";

library.add(faPlus, faTrash, faPenToSquare,faChevronRight, faChevronLeft, faEllipsisVertical, faCaretUp)
                        ...
                        /></th>
                        {
                            columns.map((column, i) =>(
                                <th
                                 ...
                                 onClick={() => SortClick(i)}
                                 >
                                    <span className={`cont-men`}><FontAwesomeIcon icon={"fa-ellipsis-vertical"}/></span>
                                    {column}
                                    <span className={`sort-men sort-${sort == "th-" + i ? sortDir : "none"}`}><FontAwesomeIcon icon={"fa-caret-up"}/></span>
                                </th>
                            ))
                        }
                    </thead>
